...
void setup()
{
  ...
  else
  {
    ...
    Serial.println();
    Serial.print("WiFi IP of roof module: ");
    Serial.println(WiFi.localIP());
    Serial.print("WiFi sending to IP: ");
    Serial.println(WiF_ipDestination);
  ...
  if (WiF_running)
    Serial.println("Sending Data Via WiFi and USB");
  else
    Serial.println("Sending Data Via USB Only");
  Serial.println();
  delay(2000);
}
